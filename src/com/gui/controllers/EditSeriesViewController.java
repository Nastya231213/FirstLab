...
public class EditSeriesViewController implements Initializable {
	...
	private void addToDataBase(ActionEvent event) {
		...
		if (checkValidation) {
            ...
            series.setDescription(descriptionOfSeries);
            series.setSeriesType(typeOfSeries);
            series.setDateOfTheStart(dateOfStart);
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		selectorOfTypeSeries.getSelectionModel().select(series.getSeriesType().getSeriesTypeName());
		selectorOfTypeSeries.setItems(values);
        name.setText(series.getName());
        description.setText(series.getDescription());
        datePicker.setValue(series.getDateOfTheStart());
